...
class Transform(_generic.DagNode):
    ...
    def data(self, worldSpace=False):
        ...
        # update data
        data['parent'] = self.parent().fullName() if self.parent() else None
    ...
    def shapes(self, shapeTypes=None, shapeTypesIncluded=True):
        ...
        for shapeType in queryShapeTypes:
            for shape in maya.cmds.listRelatives(self.fullName(), shapes=True, type=shapeType, fullPath=True) or []:
