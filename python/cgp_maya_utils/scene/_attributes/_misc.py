...
class EnumAttribute(_generic.Attribute):
    ...
    def items(self):
        ...
        itemsAsString = maya.cmds.attributeQuery(self.uniqueName(), node=self._nodeName(), listEnum=True)
    ...
    def itemIndex(self, value):
        ...
        for item in self.items():
            ...
            # get index
            index = int(newIndex) if isinstance(newIndex, str) and newIndex.isdigit() else index
